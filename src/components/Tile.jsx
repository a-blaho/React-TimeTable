        ...
        return (
            <React.Fragment>
                <div onClick={() => {this.handleModal()}} className='tile' style={{
                    ...
                    <p>{this.props.subject}<br/>
                    {this.props.teacher}<br/>
                    {this.props.classroom}</p>
                </div>
                <ReactModal isOpen={this.state.showModal} className={'reactmodal'}>
                    <div className='container'>
                        ...
                        <div className="form-floating mb-1">
                            <input type="text" className="form-control" id="subject" placeholder="subject" defaultValue={this.props.subject}/>
                            <label htmlFor="subject">Subject</label>
                        </div>
                        <div className="form-floating mb-1">
                            <input type="text" className="form-control" id="teacher" placeholder="teacher" defaultValue={this.props.teacher}/>
                            <label htmlFor="teacher">Teacher</label>
                        </div>
                        <div className="form-floating mb-1">
                            <input type="text" className="form-control" id="classroom" placeholder="classroom" defaultValue={this.props.classroom}/>
                        ...
                        <div className='row'>
                            <div className='col'>
                                ...
                                <br />
                                <input type="color" id="fontColor" defaultValue={this.props.fontColor}/>
                            </div>
                            <div className='col'>
                                <label htmlFor="backgroundColor">Background color: </label>
                                <br />
                                <input type="color" id="backgroundColor" defaultValue={this.props.backgroundColor}/>
                            </div>
                            </div>
                        <label htmlFor="size">Tile size</label>
                        <input type='number' defaultValue={this.props.size} id='size' className='form-control' min={1} max={this.props.maxSize}/>
                        <br />
